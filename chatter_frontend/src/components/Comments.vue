    ...
    >
        <div class="flex items-center space-x-4">
          ...
          <p class="text-sm text-slate-200">
            <strong>Angelica Johnson</strong>
          </p>
        </div>
      <div>
        <p class="text-sm text-slate-200">Some random ass comment here</p>
      </div>
      <div class="flex items-center justify-between w-full">
        <button
          type="button"
          @click="likeComment('some comments id here')"
...
export default {
  ...
  setup() {
    const { data, isLoading, error, isError, createCommentOnPost } =
