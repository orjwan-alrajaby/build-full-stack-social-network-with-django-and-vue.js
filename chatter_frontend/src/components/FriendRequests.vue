      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
          <template v-if="type === 'Incoming'">
            <button
              href="#"
              class="w-12 p-2 text-xs font-medium border rounded-lg border-lime-300 text-lime-300"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="block w-5 h-5 mx-auto">
            ...
            <button
              class="w-12 p-2 text-xs font-medium rounded-lg bg-lime-300 text-slate-900"
              >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="block w-5 h-5 mx-auto">
          ...
          <template v-else>
              <button class="h-10 p-2 text-xs font-medium border rounded-lg w-fit border-lime-300 text-lime-300">
